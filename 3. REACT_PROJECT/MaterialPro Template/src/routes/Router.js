...
const DesignationPage = Loadable(lazy(() => import('../views/EmployeeMasters/DesignationPage')));

const NadPost = Loadable(lazy(() => import('../views/EmployeeMasters/NadPost')));

const InspectionRequisition = Loadable(
  lazy(() => import('../views/Inspection_Requisition/Inspection-Requisition')),
);
const InspectionRequisition2 = Loadable(
  lazy(() => import('../views/Inspection_Requisition/Inspection-Requisition2')),
);
const InspectionRequisition3 = Loadable(
  lazy(() => import('../views/Inspection_Requisition/InspectionRequisition3')),
);
const InspectionRequisition4 = Loadable(
  lazy(() => import('../views/Inspection_Requisition/InspectionRequisition4')),
);
const IRForm = Loadable(lazy(() => import('../views/Inspection_Requisition/IRForm')));
...
const ThemeRoutes = [
  {
    ...
    element: <FullLayout />,
    children: [
      { path: '/', name: 'Home', element: <Navigate to="/Torpedo/Inspection-Requisition" /> },
      {
        path: '/Torpedo/Inspection-Requisition',
        name: 'Inspection-Requisition',
        exact: true,
        element: <InspectionRequisition />,
      },
      {
        path: '/Inspection_Requisition/Inspection-Requisition2',
        name: 'Inspection-Requisition2',
        exact: true,
        element: <InspectionRequisition2 />,
      },
      {
        path: '/Inspection_Requisition/Inspection-Requisition3',
        name: 'Inspection-Requisition3',
        exact: true,
        element: <InspectionRequisition3 />,
      },
      {
        path: '/InspectionRequisition/Inspection-Requisition4',
        name: 'Inspection-Requisition4',
        exact: true,
        element: <InspectionRequisition4 />,
      },
      // { path: '/dashboards/IRForm', name: 'IR Form', exact: true, element: <IRForm /> },
      {
        path: '/EmployeeMasters/DesignationPage',
        name: 'Designation',
        exact: true,
        element: <DesignationPage />,
      },
      {
        path: '/EmployeeMasters/NadPost',
        name: 'NAD Posts',
        exact: true,
        element: <NadPost />,
      },
