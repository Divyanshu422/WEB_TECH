...
//   {
//     title: 'Home',
//     icon: <MaterialIcon icon="speed" />, // Add icon to the "Home" section
//     id: 0, // Adjust the ID as per your requirement
//     collapsible: false, // Corrected the spelling of "collapsible"
//     href: '/', // Add href for the home section
//   },
//   {
//     title: 'Torpedo',
//     href: '/dashboards',
...
//       {
//         title: 'IR LIST',
//         href: '/Torpedo/Inspection-Requisition',
//         icon: <MaterialIcon icon="feed" />,
//         id: 1.1, // Adjusted the ID, assuming it's a child of "Torpedo"
//         collapsible: false,
//       },
//     ],
//   },
...
//       {
//         title: 'Designation',
//         href: '/EmployeeMasters/DesignationPage',
//         icon: <MaterialIcon icon="feed" />,
//         id: 2.1, // Adjusted the ID, assuming it's a child of "Employee Masters"
//         collapsible: false,
//       },
//       {
//         title: 'NAD Post',
//         href: '/EmployeeMasters/NadPost',
//         icon: <MaterialIcon icon="feed" />,
//         id: 2.2, // Adjusted the ID, assuming it's a child of "Employee Masters"
//         collapsible: false,
//       },
//     ],
//   },
...
const SidebarData = [
  {
    caption: 'Home',
    icon: <MaterialIcon icon="feed" />, // Add icon to the "Home" section
  },
  {
    title: 'Inspection Requisitions',
    href: '/Inspection_Requisition',
    id: 1,
    suffix: '4',
    suffixColor: 'bg-info',
    icon: <MaterialIcon icon="feed" />,
    ...
    children: [
      {
        title: 'Inspection Requisition 1',
        href: '/Inspection_Requisition/Inspection-Requisition1',
        icon: <MaterialIcon icon="feed" />,
        id: 1.1,
        collapisble: false,
      },
      {
        title: 'Inspection Requisition 2',
        href: '/Inspection_Requisition/Inspection-Requisition2',
        icon: <MaterialIcon icon="radio_button_checked" />,
        id: 1.2,
        collapisble: false,
      },
      {
        title: 'Inspection Requisition 3',
        href: '/Inspection_Requisition/Inspection-Requisition3',
        icon: <MaterialIcon icon="radio_button_checked" />,
        id: 1.3,
        collapisble: false,
      },
      {
        title: 'Inspection Requisition 4',
        href: '/Inspection_Requisition/Inspection-Requisition4',
        icon: <MaterialIcon icon="radio_button_checked" />,
        id: 1.4,
        collapisble: false,
      },
